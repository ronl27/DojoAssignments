class User < ActiveRecord::Base
  ...
  # validates :first_name, :last_name, presence: true, length:{in: 2..20},  #validates first_name to make sure its filled
  ...
  #this callback will run after updaing an existing user
  after_update :successfully_updated

  #this call will only run on creating a record to ensure a default age of 0
  ...
  def successfully_updated
    puts "Successfully updated a user"
  end
